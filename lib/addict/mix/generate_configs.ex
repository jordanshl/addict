    ...
    if addict_config_already_exists?(configs_path) do
      ...
      repo =
        case guessed do
          ...
          false ->
            Mix.shell().prompt("Please insert your Ecto Repository module:")
      ...
      user_schema =
        case guessed do
          ...
          false ->
            Mix.shell().prompt("Please insert your User Schema module:") |> String.trim_trailing()
        end
      ...
      mailgun_domain =
        case use_mailgun do
          true ->
            Mix.shell().prompt(
              "Please insert your Mailgun domain: (e.g.: https://api.mailgun.net/v3/sandbox123456.mailgun.org)"
            )
            |> String.trim_trailing()
      ...
      mailgun_api_key =
        case use_mailgun do
          true ->
            Mix.shell().prompt("Please insert your Mailgun API key:") |> String.trim_trailing()
